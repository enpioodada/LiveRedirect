...
func getTestVideoUrl(c *gin.Context) {
	...
	fmt.Fprintln(c.Writer, "#EXTINF:-1 tvg-name=\""+str_time+"\" tvg-logo=\"https://cdn.jsdelivr.net/gh/youshandefeiyang/IPTV/logo/tg.jpg\" group-title=\"频道更新时间\","+str_time)
...
func getLivePrefix(c *gin.Context) string {
	firstUrl := c.DefaultQuery("url", "http://192.168.10.5:35455")
